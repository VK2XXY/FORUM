...
$res = mysqli_select_db($conn, $mysql_base);
if (!$res)
{
...
$res = @mysqli_query($conn, "DESC $mysql_table");
if ( mysqli_errno($conn) != 0 )   //$mysql_table autocreating
{
    mysqli_query($conn, "CREATE TABLE $mysql_table (
