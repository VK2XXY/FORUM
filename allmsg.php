...
<tr><td width="2%" class=t>&nbsp;</td><td class="t"><pre><?php echo ($content != "") ? $content : "&nbsp;"; ?></pre></td><td width="2%" class=t>&nbsp;</td></tr>
</table>
</td></tr>
...
<tr>
<td align="center">
<A href="newmsg.php?id=<?php echo $val; ?>&reply=1&days=<?php echo $days; ?>&js=<?php echo $js; ?>&lang=<?php echo $lang; ?>" onClick="window.status=''; this.href=MakeMsg('id=<?php echo $val; ?>&reply=1&js=<?php echo $js; ?>&lang=<?php echo $lang; ?>'); window.location='index.php?days=<?php echo $days; ?>&js=<?php echo $js; ?>&lang=<?php echo $lang; ?>'" <?php mouse_text($msg["continue_thread"]); ?>><?php echo $msg["continue_thread"] ?></A>
</td>

<?php if ($level < $maxlevel && $pid != 0): ?>

<td align="center">
<A href="newmsg.php?id=<?php echo $val; ?>&sub_thread=1&days=<?php echo $days; ?>&js=<?php echo $js; ?>&lang=<?php echo $lang; ?>" onClick="window.status=''; this.href=MakeMsg('id=<?php echo $val; ?>&sub_thread=1&js=<?php echo $js; ?>&lang=<?php echo $lang; ?>'); window.location='index.php?days=<?php echo $days; ?>&js=<?php echo $js; ?>&lang=<?php echo $lang; ?>'" <?php mouse_text($msg["open_subthread"]); ?>><?php echo $msg["open_subthread"] ?></A>
</td>
