...
if ($action == "ok") 
{
 $q=mysqli_query($conn, "update $mysql_table set subj='$subj', author='$author', email='$email', content='$content' where id='$id'");
 $cwnd = 1;
}

$q=mysqli_query($conn, "select * from $mysql_table where id = " . $id);
...
<form name="msgform" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post" onsubmit="return formsubmit();">
...
<tr><td class="t"><b>Name:</b></td><td><input type="text" name="author" size="40" maxlength="40" value="<?php echo $author;?>">&nbsp;&nbsp;&nbsp;</td></tr>
<tr><td class="t"><b>Email:</b></td><td><input type="text" name="email" size="40" maxlength="40" value="<?php echo $email;?>">&nbsp;&nbsp;&nbsp;</td></tr>
<tr><td class="t"><b>Subject:</b></td><td><input type="text" name="subj" size="40" maxlength="50"  value="<?php echo $subj;?>">&nbsp;&nbsp;&nbsp;</td></tr>
